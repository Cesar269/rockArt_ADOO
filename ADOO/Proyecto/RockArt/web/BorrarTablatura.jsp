<%-- 
    Document   : BorrarTablatura
    Created on : 9/01/2021, 12:30:59 PM
    Author     : alex_appleby
--%>
...
<html>
    <head>
        ...
        <title>Borrar</title>
        <script src="JS/BorrarTablatura.js" type="text/javascript"></script>
    </head>
    <body>
        <%
            ...
            /////////////////////////////////////////////////////////////////////////////
            try {
                r = sta.executeQuery("select * from Tablatura where Id ='" + id + "';");
                if (r.next()) {
                    out.println("<form id='borrar' action='BorrarTablatura2.jsp' method='post'>");
                    out.println("<input type='text' style='display:none;' name ='user' value='" + id + "' >");
                    out.println("</form>");
                    out.println("<script>borra();</script>");

                } else {
                    out.print("<script>alert('No existe la tablatura');</script>");
