<%-- 
    Document   : BorrarAlbum
    Created on : 4/01/2021, 08:22:55 AM
    Author     : alex_appleby
--%>
...
<html>
    <head>
        ...
        <title>Borrar</title>
        <script src="JS/BorrarAlbum.js" type="text/javascript"></script>
    </head>
    <body>
        <%
            ...
            /////////////////////////////////////////////////////////////////////////////
            try {
                r = sta.executeQuery("select * from Album where Id ='" + id + "';");
                if (r.next()) {

                    out.println("<form id='borrar' action='BorrarAlbum2.jsp' method='post'>");
                    out.println("<input type='text' style='display:none;' name ='user' value='" + id + "' >");
                    out.println("</form>");
                    out.println("<script>borra();</script>");

                } else {
                    out.print("<script>alert('No existe el Album');</script>");
