<%-- 
    Document   : EliminarMusicoBanda
    Created on : 10/01/2021, 05:42:41 PM
    Author     : alex_appleby
--%>
...
<html>
    <head>
        ...
        <title>Eliminar Musico Banda</title>
    </head>
    <body>
        <%
            int id = Integer.parseInt(request.getParameter("id5").toString());
            String NombreCompleto = request.getParameter("eliminar_musico_banda");
            ...
            try {
                ...
                if (bandera) {
                    ...
                    while (s.next()) {
                        ...
                        if ((Nombre + " " + Apellido_Paterno + " " + Apellido_Materno).equalsIgnoreCase(NombreCompleto)) {
                            sta3.executeUpdate("delete  from Registro_Banda_Musicos where Id_Musico =" + Id + ";"); //aqui no lleva el * en el delete
                            out.print("<script> alert('Musico eliminado de la banda exitosamente'); </script>");
